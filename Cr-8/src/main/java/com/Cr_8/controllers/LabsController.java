...
public class LabsController {
	...
	public ResponseEntity<?> addNewLab(@RequestBody LabsDTO labsDTO){
		String newlabs =labsService.addNewLabs(labsDTO.getName(), labsDTO.getDescription(),labsDTO.getScope(),labsDTO.getTargetDescription(),labsDTO.getDuration(),labsDTO.getImg());
